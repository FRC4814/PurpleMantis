...
public class cRIOPorts {
    ...
    public static final int WINCH1 = 5;
    public static final int WINCH2 = 6;
    ...
    public static final int LEFT_JOYSTICK = 1; // 3 
    public static final int RIGHT_JOYSTICK = 2; // 1
    public static final int WINCH_JOYSTICK = 3; // 2
    
    public static final int SHOOTER_ENCODER = 7;
    public static final int SHOOTER_RATE_ENCODER = -1;
